...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('imgs/fanvicon.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('imgs/fanvicon.png') }}" type="image/x-icon">
        ...
        <div class="box-content-header">
            <div class="content-header-tab">
                <div class="content-header-tab-1">
                    <a href="{{ route('app') }}"><img class="logo-header" src="{{ asset('imgs/LOGO.png') }}" /></a>
                    ...
                    @unless (request()->is('login'))
                        <nav class="list-page">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('orders') }}"
                                        class="btn-header-1 {{ Request::is('order') ? 'active' : '' }} link-line">ĐẶT
                                        HÀNG</a>
                                </li>
                            </ul>
                        </nav>
                ...
                <div class="content1-main">
                    <div class="footer-widget">
                        <a href="index.html" class="footer-widget__Logo">
                            <img class="logo-footer" src="{{ asset('imgs/LOGO.png') }}" />
                        </a>
